...
func (d *Driver) CreateReadWrite(id, parent string, opts *graphdriver.CreateOpts) error {
	logrus.Debugf("overlay2: CreateReadWrite => id: %s, parent: %s, opts: %s", id, parent, opts)
...
func (d *Driver) Create(id, parent string, opts *graphdriver.CreateOpts) (retErr error) {
	...
	logrus.Debugf("overlay2: Create => id: %s, parent: %s, opts: %s", id, parent, opts)
...
func (d *Driver) Remove(id string) error {
	logrus.Debugf("overlay2: Remove => id: %s", id)
...
func (d *Driver) Get(id string, mountLabel string) (s string, err error) {
	logrus.Debugf("overlay2: Get => id: %s, label: %s", id, mountLabel)
...
func (d *Driver) Put(id string) error {
	logrus.Debugf("overlay2: Put => id: %s", id)
...
func (d *Driver) ApplyDiff(id string, parent string, diff io.Reader) (size int64, err error) {
	logrus.Debugf("overlay2: ApplyDiff => id: %s, parent: %s", id, parent)
...
func (d *Driver) Diff(id, parent string) (io.ReadCloser, error) {
	logrus.Debugf("overlay2: Diff => id: %s, parent: %s", id, parent)
...
func (d *Driver) Changes(id, parent string) ([]archive.Change, error) {
	logrus.Debugf("overlay2: Changes => id: %s, parent: %s", id, parent)
