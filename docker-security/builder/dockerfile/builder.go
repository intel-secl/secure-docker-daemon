...
func BuildFromConfig(config *container.Config, changes []string) (*container.Config, error) {
	logrus.Debugf("BuildFromConfig: config: %v", config)
	...
	b.options.StorageOpt = strings.Split(config.StorageOpt, " ")
	logrus.Debugf("BuildFromConfig: b.options.StorageOpt: %s", b.options.StorageOpt)
