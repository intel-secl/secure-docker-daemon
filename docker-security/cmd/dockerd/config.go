...
func installCommonConfigFlags(conf *config.Config, flags *pflag.FlagSet) {
	...
	flags.StringVar(&conf.RemoteRoot, "data-remote-root", defaultDataRemoteRoot, "Remote root directory of persistent Docker state, extend local storage over NFS etc.")
